...
const addCarrito = e => {
    if (e.target.classList.contains('btn-dark')) {
        ...
        <button class="btn btn-info botonVerLista"><a href="#footer" id="botonVerFooter">Ver Lista</a></button>`)
...
const pintarFooter = () => {
    ...
    const boton2 = document.querySelector('#cerrarCompra')
    ...
    $('#finalizarCompra').on('click', function() {
        ...
        <p>cantidad de productos: ${nCantidad}</p>
        <p>precio total: $${nPrecio}
        <br>
        <p>En la brevedad nos contactaremos para coordinar el envio</p>`)
